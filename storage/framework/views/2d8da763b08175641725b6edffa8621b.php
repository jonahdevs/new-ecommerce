...
<?php endif; ?>
    ...
    <div class="container mx-auto px-4 mt-5 md:mt-7">
        ...
        <?php if (isset($__livewire)) echo $__livewire->renderIslandDirective('top-categories', token: 'ffbd6668-1'); ?>
    </div>
...
<?php endif; ?>
            ...
            <?php if (isset($__livewire)) echo $__livewire->renderIslandDirective('new-arrivals', defer: true, token: 'ffbd6668-2'); ?>
...
<?php endif; ?>
            ...
            <?php if (isset($__livewire)) echo $__livewire->renderIslandDirective(name: 'products', defer: true, token: 'ffbd6668-3'); ?>
...
</div><?php /**PATH C:\Users\jonah\OneDrive\Desktop\ecommerce\sheffield_ecommerce\storage\framework/views/livewire/views/d64e4312.blade.php ENDPATH**/ ?>