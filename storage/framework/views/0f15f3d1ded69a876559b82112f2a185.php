...
<?php endif; ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($this->imageSlides) > 1 && $product->type->value !== 'grouped'): ?>
...
<?php endif; ?>
                                ...
                                <?php elseif(count($this->imageSlides) > 1): ?>
...
<?php endif; ?>
                                ...
                                <div
                                    ...
                                    <span class="text-xs text-zinc-500 dark:text-zinc-400">
                                        <?php echo e(count($selectedGroupedItems)); ?> of <?php echo e($this->groupedProducts->count()); ?>
...
<?php endif; ?>
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($state === 'none'): ?>
                                    <p class="text-xs sm:text-sm text-zinc-400 mt-1">Select options to see availability
                                    </p>
                                <?php elseif($state === 'available'): ?>
