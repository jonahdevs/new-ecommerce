...
countyName = <?php echo e($countyNameInit); ?>;"
    ...
    <div x-show="step === 'map'">
        <div class="p-6 space-y-5">
            ...
            <div>
                <label class="<?php echo e($labelClass); ?>">Search location</label>
                <div class="flex">
...
<?php endif; ?>
                ...
                <p x-show="searchNotFound" x-cloak class="<?php echo e($errorClass); ?> mt-1.5">
            ...
            <div x-show="hasPinned && !countyResolved && !countyResolving" x-cloak class="space-y-3">
                ...
                <div>
                    <label class="<?php echo e($labelClass); ?>">County *</label>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'primary','type' => 'button','class' => 'inline-flex items-center gap-2','x-bind:disabled' => '!hasPinned || !countyResolved || countyResolving','x-bind:class' => '(!hasPinned || !countyResolved || countyResolving) ? \'opacity-40 cursor-not-allowed!\' : \'\'','@click' => 'step = \'form\'']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
    ...
    ?>
<?php /**PATH C:\Users\jonah\Herd\sheffield_ecommerce\resources\views\pages\customer\address-book\_form-fields.blade.php ENDPATH**/ ?>