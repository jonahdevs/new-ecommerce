            ...
            <div class="mb-3.5">
                ...
                <div class="relative">
                    <input :type="$wire.showCurrentPassword ? 'text' : 'password'"
                        wire:model="current_password" placeholder="Enter current password" class="<?php echo e($inputClass); ?>" required>
                    <button type="button" @click="$wire.showCurrentPassword = !$wire.showCurrentPassword" class="<?php echo e($eyeBtnClass); ?>">
            ...
            <div class="mb-3.5">
                ...
                <div class="relative">
                    <input :type="$wire.showNewPassword ? 'text' : 'password'"
                        wire:model.live="password" placeholder="Min. 8 characters" class="<?php echo e($inputClass); ?>" required>
                    <button type="button" @click="$wire.showNewPassword = !$wire.showNewPassword" class="<?php echo e($eyeBtnClass); ?>">
                        <?php if (isset($component)) { $__componentOriginal2e57535a42d25d5415c31aa83132341b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2e57535a42d25d5415c31aa83132341b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.eye','data' => ['class' => 'w-4 h-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::icon.eye'); ?>
                    ...
                    <div class="mt-2">
                        <div class="h-[3px] bg-zinc-200 rounded-full overflow-hidden mb-1">
                            <div class="h-full rounded-full transition-all duration-300"
                                style="width: <?php echo e($strength['strength']); ?>%; background-color: <?php echo e($strength['color']); ?>"></div>
                        </div>
            ...
            <div>
                ...
                <div class="relative">
                    <input :type="$wire.showConfirmPassword ? 'text' : 'password'"
                        wire:model="password_confirmation" placeholder="Repeat new password" class="<?php echo e($inputClass); ?>" required>
                    <button type="button" @click="$wire.showConfirmPassword = !$wire.showConfirmPassword" class="<?php echo e($eyeBtnClass); ?>">
                        <?php if (isset($component)) { $__componentOriginal2e57535a42d25d5415c31aa83132341b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal2e57535a42d25d5415c31aa83132341b = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.eye','data' => ['class' => 'w-4 h-4']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::icon.eye'); ?>
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->twoFactorEnabled): ?>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(! $this->twoFactorConfirmed): ?>
                        <div class="bg-amber-50 border border-amber-200 p-4 mb-4">
                            <div class="text-[12px] text-amber-900 font-semibold mb-3"><?php echo e(__('Scan this QR code in your authenticator app, then enter the generated code on your next sign-in to confirm setup.')); ?></div>
...
<?php endif; ?>
                            ...
                            <div class="text-[11px] text-zinc-500 mt-2"><?php echo e(__('Each code can only be used once. Store them somewhere safe.')); ?></div>
                        </details>
                    </div>
...
<?php endif; ?>
            ...
            <div class="flex-1 min-w-0">
                <div class="text-[13px] font-bold text-zinc-950"><?php echo e($this->currentSession['browser']); ?> on <?php echo e($this->currentSession['platform']); ?></div>
                <div class="text-[11px] text-zinc-500 mt-0.5"><?php echo e($this->currentSession['ip'] ?: 'Unknown IP'); ?> · Active now</div>
            </div>
