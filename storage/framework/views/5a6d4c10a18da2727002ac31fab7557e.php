...
<?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->shipping && $this->shipping['method_type'] === 'quote'): ?>
...
<?php endif; ?>
                    ...
                    <span class="font-semibold text-sm">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->shipping['method_type'] === 'quote'): ?>
                            <span class="text-amber-500 font-medium text-sm">TBD</span>
                        <?php elseif($this->shipping['cost'] == 0): ?>
                            <span class="text-green-600 font-medium text-sm">Free</span>
                        <?php else: ?>
                            <?php echo e(format_currency($this->shipping['cost'])); ?>
