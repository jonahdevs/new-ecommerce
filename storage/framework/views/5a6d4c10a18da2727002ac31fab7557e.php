...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.chevron-right','data' => ['class' => 'size-3.5 stroke-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'size-3.5 stroke-2']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
        ...
        <div class="p-5">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->address): ?>
                <span
                    class="inline-block text-[9px] font-black uppercase tracking-widest px-2 py-0.5 bg-zinc-950 text-white mb-2"><?php echo e($this->address->label ?? 'Home'); ?></span>
...
<?php endif; ?>
        ...
        <div class="p-5 md:px-6">
            ...
            <div class="flex items-center gap-4">
                ...
                <div>
                    <div class="text-[14px] font-bold text-zinc-950 mb-0.5"><?php echo e($pmName); ?></div>
...
<?php endif; ?>
    ...
    <div
        ...
        <button @click="$dispatch('place-order')" x-data="{ processing: false }" @place-order.window="processing = true"
            :disabled="!<?php echo \Illuminate\Support\Js::from($this->address)->toHtml() ?> || !<?php echo \Illuminate\Support\Js::from($this->shipping)->toHtml() ?> || processing"
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.plus','data' => ['class' => 'size-[18px] text-zinc-300 group-hover:text-primary transition-colors']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'size-[18px] text-zinc-300 group-hover:text-primary transition-colors']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
            ...
            <div class="p-6 max-h-[70vh] overflow-y-auto">
             ...
             <?php $__env->slot('footer', null, []); ?> 
                <div class="px-6 py-4 border-t border-zinc-200 flex gap-2.5 justify-end">
                    ...
                    <button type="button" wire:click="confirmShipping" :disabled="!<?php echo \Illuminate\Support\Js::from($selectedMethod)->toHtml() ?>"
