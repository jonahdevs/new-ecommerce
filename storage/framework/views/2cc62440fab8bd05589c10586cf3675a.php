...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.loading','data' => ['wire:loading' => true,'wire:target' => 'setDateRange,exportCsv','class' => 'dark:text-white! size-3.5']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:loading' => true,'wire:target' => 'setDateRange,exportCsv','class' => 'dark:text-white! size-3.5']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
            ...
            <?php if (isset($component)) { $__componentOriginale0fd5b6a0986beffac17a0a103dfd7b9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale0fd5b6a0986beffac17a0a103dfd7b9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::heading','data' => ['size' => 'xl','class' => 'text-2xl! font-bold! mb-1.5','wire:key' => 'kpi-revenue-'.e($this->salesStats['revenue']).'','xData' => 'countUp({ to: '.e($this->salesStats['revenue']).', decimals: 2, prefix: \'KES \' })','xIntersect.once' => 'start()','xText' => 'display']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::heading'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['size' => 'xl','class' => 'text-2xl! font-bold! mb-1.5','wire:key' => 'kpi-revenue-'.e($this->salesStats['revenue']).'','x-data' => 'countUp({ to: '.e($this->salesStats['revenue']).', decimals: 2, prefix: \'KES \' })','x-intersect.once' => 'start()','x-text' => 'display']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
            ...
            <?php if (isset($component)) { $__componentOriginale0fd5b6a0986beffac17a0a103dfd7b9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale0fd5b6a0986beffac17a0a103dfd7b9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::heading','data' => ['size' => 'xl','class' => 'text-2xl! font-bold! mb-1.5','wire:key' => 'kpi-orders-'.e($this->salesStats['order_count']).'','xData' => 'countUp({ to: '.e($this->salesStats['order_count']).' })','xIntersect.once' => 'start()','xText' => 'display']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::heading'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['size' => 'xl','class' => 'text-2xl! font-bold! mb-1.5','wire:key' => 'kpi-orders-'.e($this->salesStats['order_count']).'','x-data' => 'countUp({ to: '.e($this->salesStats['order_count']).' })','x-intersect.once' => 'start()','x-text' => 'display']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
            ...
            <?php if (isset($component)) { $__componentOriginale0fd5b6a0986beffac17a0a103dfd7b9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale0fd5b6a0986beffac17a0a103dfd7b9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::heading','data' => ['size' => 'xl','class' => 'text-2xl! font-bold! mb-1.5','wire:key' => 'kpi-customers-'.e($this->customerStats['total']).'','xData' => 'countUp({ to: '.e($this->customerStats['total']).' })','xIntersect.once' => 'start()','xText' => 'display']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::heading'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['size' => 'xl','class' => 'text-2xl! font-bold! mb-1.5','wire:key' => 'kpi-customers-'.e($this->customerStats['total']).'','x-data' => 'countUp({ to: '.e($this->customerStats['total']).' })','x-intersect.once' => 'start()','x-text' => 'display']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
            ...
            <?php if (isset($component)) { $__componentOriginale0fd5b6a0986beffac17a0a103dfd7b9 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale0fd5b6a0986beffac17a0a103dfd7b9 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::heading','data' => ['size' => 'xl','class' => 'text-2xl! font-bold! mb-1.5','wire:key' => 'kpi-products-'.e($this->productStats['active']).'','xData' => 'countUp({ to: '.e($this->productStats['active']).' })','xIntersect.once' => 'start()','xText' => 'display']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::heading'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['size' => 'xl','class' => 'text-2xl! font-bold! mb-1.5','wire:key' => 'kpi-products-'.e($this->productStats['active']).'','x-data' => 'countUp({ to: '.e($this->productStats['active']).' })','x-intersect.once' => 'start()','x-text' => 'display']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
        ...
        <?php $salesLocations = $this->topSalesLocations; ?>
...
<?php endif; ?>
            ...
            <div class="px-4 py-4">
                <div wire:ignore id="dashboard-sales-map"
                    data-locations="<?php echo e(json_encode($salesLocations)); ?>"
...
<?php endif; ?>
            ...
            <div class="px-5 py-4">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $this->recentActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                    ...
                    <div class="relative flex gap-3 <?php echo e($loop->last ? '' : 'pb-5'); ?>">
                        ...
                        <div class="relative shrink-0 size-7 rounded-full <?php echo e($bgClass); ?> flex items-center justify-center">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(str_contains($desc, 'payment')): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.currency-dollar','data' => ['class' => 'size-3.5 '.e($iconClass).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'size-3.5 '.e($iconClass).'']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                            <?php elseif(str_contains($desc, 'order')): ?>
                                <?php if (isset($component)) { $__componentOriginalc43f195f1b3468dd3dad13eb2914c8e1 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc43f195f1b3468dd3dad13eb2914c8e1 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.shopping-bag','data' => ['class' => 'size-3.5 '.e($iconClass).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::icon.shopping-bag'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php unset($__componentOriginalc43f195f1b3468dd3dad13eb2914c8e1); ?>
<?php endif; ?>
                            <?php elseif(str_contains($desc, 'inventory') || str_contains($desc, 'stock')): ?>
                                <?php if (isset($component)) { $__componentOriginal82067727c95f13dc4198f80e35cb9c11 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal82067727c95f13dc4198f80e35cb9c11 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.chart-bar','data' => ['class' => 'size-3.5 '.e($iconClass).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::icon.chart-bar'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php unset($__componentOriginal82067727c95f13dc4198f80e35cb9c11); ?>
<?php endif; ?>
                            <?php elseif(str_contains($desc, 'sap') || str_contains($desc, 'sync')): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.arrow-path','data' => ['class' => 'size-3.5 '.e($iconClass).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                            <?php elseif(str_contains($desc, 'quote')): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.document-text','data' => ['class' => 'size-3.5 '.e($iconClass).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                            <?php elseif(str_contains($desc, 'user') || str_contains($desc, 'customer')): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.user','data' => ['class' => 'size-3.5 '.e($iconClass).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                            <?php elseif(str_contains($desc, 'webhook')): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.bell','data' => ['class' => 'size-3.5 '.e($iconClass).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                            <?php elseif(str_contains($desc, 'product')): ?>
                                <?php if (isset($component)) { $__componentOriginald5dcfefa1bd397da70b3e8652c3e12ee = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginald5dcfefa1bd397da70b3e8652c3e12ee = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.cube','data' => ['class' => 'size-3.5 '.e($iconClass).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('flux::icon.cube'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
...
<?php unset($__componentOriginald5dcfefa1bd397da70b3e8652c3e12ee); ?>
<?php endif; ?>
                            <?php elseif(str_contains($desc, 'shipping') || str_contains($desc, 'delivery')): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.truck','data' => ['class' => 'size-3.5 '.e($iconClass).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                            <?php elseif(str_contains($desc, 'login') || str_contains($desc, 'auth')): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.lock-closed','data' => ['class' => 'size-3.5 '.e($iconClass).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.bolt','data' => ['class' => 'size-3.5 '.e($iconClass).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
                        ...
                        <div class="flex-1 min-w-0 -mt-0.5">
                            <div class="flex items-start justify-between gap-2">
                                <p class="text-xs font-semibold text-zinc-800 dark:text-zinc-200 leading-snug">
                                    <?php echo e(str_replace('_', ' ', ucwords($desc, '_'))); ?>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($activity->causer): ?>
                                <p class="text-[10px] text-zinc-400 mt-0.5"><?php echo e($activity->causer->name ?? 'System'); ?></p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                            ...
                            <tr class="hover:bg-zinc-50 dark:hover:bg-zinc-800/40 transition-colors">
                                <td class="px-5 py-3">
                                    <a href="<?php echo e(route('admin.orders.show', $order)); ?>" wire:navigate
                                        class="block text-blue-600 dark:text-blue-400 font-medium text-xs hover:underline"><?php echo e($order->reference); ?></a>
...
<?php $component->withAttributes([]); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
Low stock report <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginale0fd5b6a0986beffac17a0a103dfd7b9)): ?>
<?php $attributes = $__attributesOriginale0fd5b6a0986beffac17a0a103dfd7b9; ?>
<?php unset($__attributesOriginale0fd5b6a0986beffac17a0a103dfd7b9); ?>
...
<?php endif; ?>
            ...
            <div class="p-5 flex flex-col flex-1">
                ...
                <div id="satisfactionChartData"
                    data-distribution="<?php echo e(json_encode(array_values($this->satisfactionStats['distribution']))); ?>"
                    data-average="<?php echo e($this->satisfactionStats['average'] ?? 0); ?>"
                    data-total="<?php echo e($this->satisfactionStats['total']); ?>">
                </div>
                ...
                <div class="relative flex items-center justify-center" style="height:180px;">
                    ...
                    <div class="absolute flex flex-col items-center justify-center pointer-events-none">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->satisfactionStats['average']): ?>
                            <span class="text-2xl font-bold text-zinc-900 dark:text-zinc-100 leading-none">
                                <?php echo e($this->satisfactionStats['average']); ?>
                ...
                <div class="mt-5 flex flex-col gap-2">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $ratingColors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $star => $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                        <?php
                            $count = $this->satisfactionStats['distribution'][$star] ?? 0;
                            $pct = $reviewTotal > 0 ? round(($count / $reviewTotal) * 100) : 0;
                        ?>
                        <div class="flex items-center gap-2">
                            <span class="text-[10px] text-zinc-500 w-3 shrink-0"><?php echo e($star); ?></span>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::icon.star','data' => ['class' => 'size-3 shrink-0','style' => 'color: '.e($color).';']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'size-3 shrink-0','style' => 'color: '.e($color).';']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php endif; ?>
                            <div class="flex-1 h-1.5 rounded-full bg-zinc-100 dark:bg-zinc-800 overflow-hidden">
                                <div class="h-full rounded-full transition-all duration-500"
                                    style="width: <?php echo e($pct); ?>%; background-color: <?php echo e($color); ?>;"></div>
                            </div>
                            <span class="text-[10px] text-zinc-400 w-5 text-right shrink-0"><?php echo e($count); ?></span>
                        </div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                            <div class="rounded-xl border border-zinc-100 dark:border-zinc-800 p-3 text-center">
                                <p class="text-base font-bold text-zinc-900 dark:text-zinc-100 mb-1"
                                    x-data="countUp({ to: <?php echo e($cat['units']); ?> })" x-intersect.once="start()" x-text="display">
                                </p>
                                <p
                    ...
                    <div class="flex flex-col gap-1">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-xs font-semibold text-zinc-800 dark:text-zinc-200 shrink-0"
                                x-data="countUp({ to: <?php echo e($item['pct']); ?>, suffix: '%' })" x-intersect.once="start()" x-text="display"></span>
                        </div>
...
<?php endif; ?>
    ...
    ?><?php /**PATH C:\Users\jonah\Herd\sheffield_ecommerce\storage\framework/views/livewire/views/ed324034.blade.php ENDPATH**/ ?>