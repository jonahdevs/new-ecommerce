                ...
                <div class="w-full @md:w-48 shrink-0 flex flex-col divide-y divide-zinc-100 dark:divide-zinc-800">
                    ...
                    <div class="px-5 py-4">
                        ...
                        <p class="text-2xl font-bold text-zinc-900 dark:text-zinc-100 leading-none"
                            <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'chart-orders-'.e($this->salesStats['order_count']).''; ?>wire:key="chart-orders-<?php echo e($this->salesStats['order_count']); ?>" x-data="countUp({ to: <?php echo e($this->salesStats['order_count']); ?> })" x-intersect.once="start()"
                            x-text="display">
                        </p>
                    </div>
                    ...
                    <div class="px-5 py-4">
                        ...
                        <p class="text-lg font-bold text-zinc-900 dark:text-zinc-100 leading-none break-all"
                            <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'chart-revenue-'.e($this->salesStats['revenue']).''; ?>wire:key="chart-revenue-<?php echo e($this->salesStats['revenue']); ?>" x-data="countUp({ to: <?php echo e($this->salesStats['revenue']); ?>, decimals: 2, prefix: 'KES ' })" x-intersect.once="start()"
                            x-text="display">
                        </p>
                    </div>
                    ...
                    <div class="px-5 py-4">
                        ...
                        <p class="text-2xl font-bold text-zinc-900 dark:text-zinc-100 leading-none"
                            <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'chart-paid-'.e($this->salesStats['paid_count']).''; ?>wire:key="chart-paid-<?php echo e($this->salesStats['paid_count']); ?>" x-data="countUp({ to: <?php echo e($this->salesStats['paid_count']); ?> })" x-intersect.once="start()"
                            x-text="display">
                        </p>
                    </div>
                    ...
                    <div class="px-5 py-4">
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($this->quotationStats['conversion_rate'] !== null): ?>
                            <p class="text-2xl font-bold text-emerald-500 leading-none"
                                ...
                                x-data="countUp({ to: <?php echo e($this->quotationStats['conversion_rate']); ?>, decimals: 1, suffix: '%' })" x-intersect.once="start()" x-text="display">
                            </p>
                        <?php else: ?>
...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
Orders by Kenya county · hover for detail <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal0638ebfbd490c7a414275d493e14cb4e)): ?>
<?php $attributes = $__attributesOriginal0638ebfbd490c7a414275d493e14cb4e; ?>
<?php unset($__attributesOriginal0638ebfbd490c7a414275d493e14cb4e); ?>
