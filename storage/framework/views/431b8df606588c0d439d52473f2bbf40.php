...
<?php $component = Mary\View\Components\ChoicesOffline::resolve(['options' => $this->products,'optionSubLabel' => 'sku','optionAvatar' => 'image_url','searchable' => true,'clearable' => true] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'selectedGroupedProducts','placeholder' => 'Search and select products...']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'e60dd9d2c3a62d619c9acb38f20d5aa5::button.index','data' => ['type' => 'button','icon' => 'plus','wire:click' => 'addGroupedProducts','disabled' => empty($selectedGroupedProducts),'class' => 'cursor-pointer']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'button','icon' => 'plus','wire:click' => 'addGroupedProducts','disabled' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(empty($selectedGroupedProducts)),'class' => 'cursor-pointer']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
                ...
                <div class="divide-y dark:divide-zinc-700">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $groupedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                        <div class="grid grid-cols-12 gap-3 px-4 py-3 items-center"
                            <?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::$currentLoop['key'] = 'grouped-'.e($index).''; ?>wire:key="grouped-<?php echo e($index); ?>">
...
<?php endif; ?>
                            ...
                            <div class="col-span-2 text-right text-sm text-zinc-500 dark:text-zinc-400">
                                KES <?php echo e(number_format($item['price'] ?? 0, 2)); ?>

                            </div>

                            
                            <div class="col-span-2 text-right text-sm font-medium text-zinc-800 dark:text-zinc-100">
                                KES <?php echo e(number_format(($item['price'] ?? 0) * ($item['quantity'] ?? 1), 2)); ?>
...
<?php endif; ?>
                ...
                <div
                    ...
                    <div class="col-span-9 text-sm font-medium text-zinc-500 text-right">
                        Kit Total
                    </div>
                    <div class="col-span-2 text-right text-sm font-bold text-zinc-800 dark:text-zinc-100">
                        KES <?php echo e(number_format($this->getGroupedTotal(), 2)); ?>
...
<?php $attributes = $attributes->except(\Mary\View\Components\ChoicesOffline::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['wire:model' => 'form.selected_cross_sells','placeholder' => 'Select products for cross-sells (e.g. Accessories)']); ?>
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
