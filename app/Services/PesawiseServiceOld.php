...
class PesawiseServiceOld
{
    ...
    private function buildPayload(Order $order): array
    {
        ...
        $callbackUrl = route('payment.callback') . '?order_id=' . $order->id . '&reference=' . $order->reference;
        $cancellationUrl = route('payment.cancel') . '?order_id=' . $order->id . '&reference=' . $order->reference;
        ...
        Log::info('Pesawise payload being sent', [
            'order_id' => $order->id,
            'payload' => $payload,
            'callback_url' => $callbackUrl,
            'cancellation_url' => $cancellationUrl,
            'notification_id' => (string) $order->id,
        ]);
