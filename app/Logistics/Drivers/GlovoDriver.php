...
class GlovoDriver implements LogisticsDriver
{
    public function __construct(ShippingCarrier $carrier)
    {
        // Glovo Partner API credentials from $carrier->credentials
    }

    public function getQuote(Order $order): QuoteResult
    {
        return QuoteResult::unavailable('Glovo integration not yet configured.');
    }

    public function book(Order $order): BookingResult
    {
        return BookingResult::failed('Glovo integration not yet configured.');
    }

    public function track(Shipment $shipment): TrackingResult
    {
        return TrackingResult::failed('Glovo integration not yet configured.');
    }
