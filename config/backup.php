...
return [
    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                ...
                'include' => [
                    base_path(),
                    // Include storage/app/public for uploaded files
        ...
        'destination' => [
             ...
             */
            'filename_prefix' => env('BACKUP_FILENAME_PREFIX', 'sheffield-backup-'),
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => env('BACKUP_NOTIFICATION_EMAIL', 'admin@sheffieldafrica.com'),

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'hello@example.com'),
                'name' => env('MAIL_FROM_NAME', 'Sheffield Backup System'),
            ],
        ],
