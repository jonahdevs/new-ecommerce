...
return new class extends SettingsMigration
{
    public function up(): void
    {
        ...
        $this->migrator->add('payment.pesapal_consumer_secret', null);
        $this->migrator->add('payment.pesapal_webhook_secret', null);
        ...
        $this->migrator->add('payment.mpesa_consumer_secret', null);
        $this->migrator->add('payment.mpesa_shortcode', null);
        $this->migrator->add('payment.mpesa_passkey', null);
