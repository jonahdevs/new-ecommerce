...
return new class extends SettingsMigration {
    public function up(): void
    {
        ...
        // Pesapal
        $this->migrator->add('payment.pesapal_env', 'sandbox');
        ...
        // PayPal
        $this->migrator->add('payment.paypal_env', 'sandbox');
        ...
        // Stripe
        $this->migrator->add('payment.stripe_env', 'sandbox');
        ...
        // M-Pesa Daraja
        $this->migrator->add('payment.mpesa_env', 'sandbox');
