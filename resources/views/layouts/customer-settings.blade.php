<x-layouts::guest>
    ...
    <div class="container mx-auto px-4 py-5 lg:py-7 pb-12 lg:pb-15">
        <div class="grid grid-cols-1 md:grid-cols-[220px_1fr] gap-6 items-start">
            ...
            <nav
                class="bg-white border border-zinc-200 sticky top-[calc(var(--nav-h,64px)+16px)] overflow-hidden max-md:static max-md:flex max-md:overflow-x-auto">
                <flux:navlist class="w-full [&_svg]:w-5 [&_svg]:h-5">
                    ...
                    <flux:navlist.item type="submit" icon="arrow-right-start-on-rectangle"
                        class="text-red-500! cursor-pointer hover:bg-red-50!">Back to Account
                    </flux:navlist.item>
