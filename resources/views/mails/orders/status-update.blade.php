...
<body style="margin: 0; width: 100%; background-color: #f1f5f9; padding: 0; -webkit-font-smoothing: antialiased; word-break: break-word;">
    ...
    <div style="display: none; max-height: 0; overflow: hidden;">
        Your order {{ $order->reference }} has been updated to {{ $newStatus->label() }}.
        &#8199;&#65279;&#847; &#8199;&#65279;&#847; &#8199;&#65279;&#847; &#8199;&#65279;&#847; &#8199;&#65279;&#847;
        &#8199;&#65279;&#847; &#8199;&#65279;&#847; &#8199;&#65279;&#847; &#8199;&#65279;&#847; &#8199;&#65279;&#847;
        &#8199;&#65279;&#847; &#8199;&#65279;&#847; &#8199;&#65279;&#847; &#8199;&#65279;&#847; &#8199;&#65279;&#847;
        &#8199;&#65279;&#847; &#8199;&#65279;&#847; &#8199;&#65279;&#847; &#8199;&#65279;&#847; &#8199;&#65279;&#847;
                            ...
                            <tr>
                                <td class="card" style="border-radius: 8px; background-color: #ffffff; padding: 28px 32px; border: 1px solid #c02434;">
                                    ...
                                    <p class="intro" style="margin: 0 0 20px; font-size: 13px; line-height: 20px; color: #475569;">
                                        Your order <strong style="color: #1e293b;">{{ $order->reference }}</strong> has been updated to
                                    ...
                                    <table cellpadding="0" cellspacing="0" role="presentation" style="width: 100%; margin-bottom: 20px;">
                                        <tr>
                                            ...
                                            {{-- Processing --}}
                                            @php $processingActive = in_array($newStatus->value, ['processing', 'shipped', 'delivered']); @endphp
                                            <td style="width: 32px; text-align: center;">
                                                <div class="{{ $processingActive ? 'step-icon-on' : 'step-icon-off' }}" style="margin: 0 auto; {{ $processingActive ? 'line-height: 32px;' : 'display: flex; align-items: center; justify-content: center;' }} height: 32px; width: 32px; border-radius: 50%; background-color: {{ $processingActive ? '#c02434' : '#f1f5f9' }}; padding: 6px; {{ $processingActive ? '' : 'border: 1px solid #e2e8f0;' }} text-align: center; color: {{ $processingActive ? '#fff' : '#94a3b8' }};">
                                                    <svg fill="currentColor" viewBox="0 0 100 125" style="width:100%;height:100%;">
                                                        ...
                                                        <path d="M56.5,87.5h-13l-1.7-7.8c-2.1-0.7-4.1-1.6-5.9-2.8l-7.3,3.3l-9.2-9.2l3.3-7.3c-1.2-1.8-2.1-3.8-2.8-5.9l-7.8-1.7v-13 l7.8-1.7c0.7-2.1,1.6-4.1,2.8-5.9l-3.3-7.3l9.2-9.2l7.3,3.3c1.8-1.2,3.8-2.1,5.9-2.8l1.7-7.8h13l1.7,7.8 c2.1,0.7,4.1,1.6,5.9,2.8l7.3-3.3l9.2,9.2l-3.3,7.3c1.2,1.8,2.1,3.8,2.8,5.9l7.8,1.7v13l-7.8,1.7c-0.7,2.1-1.6,4.1-2.8,5.9 l3.3,7.3l-9.2,9.2l-7.3-3.3c-1.8,1.2-3.8,2.1-5.9,2.8L56.5,87.5z M47,83.5h6.1l1.5-7.1l1.3-0.4c2.5-0.8,4.8-2,6.9-3.5l1.1-0.8 l6.6,3l4.3-4.3l-3-6.6l0.8-1.1c1.5-2.1,2.7-4.4,3.5-6.9l0.4-1.3l7.1-1.5V47l-7.1-1.5l-0.4-1.3c-0.8-2.5-2-4.8-3.5-6.9l-0.8-1.1 l3-6.6l-4.3-4.3l-6.6,3l-1.1-0.8c-2.1-1.5-4.4-2.7-6.9-3.5l-1.3-0.4L53,17h-6.1l-1.5,7.1l-1.3,0.4c-2.5,0.8-4.8,2-6.9,3.5 l-1.1,0.8l-6.6-3l-4.3,4.3l3,6.6l-0.8,1.1c-1.5,2.1-2.7,4.4-3.5,6.9L24.5,47L17.4,47v6.1l7.1,1.5l0.4,1.3 c0.8,2.5,2,4.8,3.5,6.9l0.8,1.1l-3,6.6l4.3,4.3l6.6-3l1.1,0.8c2.1,1.5,4.4,2.7,6.9,3.5l1.3,0.4L47,83.5z"/>
                                                    </svg>
                                                </div>
                                            </td>
                                            <td style="vertical-align: middle;"><div style="height: 3px; background-color: {{ in_array($newStatus->value, ['shipped', 'delivered']) ? '#c02434' : '#e2e8f0' }};"></div></td>
                                            {{-- Shipped --}}
                                            @php $shippedActive = in_array($newStatus->value, ['shipped', 'delivered']); @endphp
                                            <td style="width: 32px; text-align: center;">
                                                <div class="{{ $shippedActive ? 'step-icon-on' : 'step-icon-off' }}" style="margin: 0 auto; {{ $shippedActive ? 'line-height: 32px;' : 'display: flex; align-items: center; justify-content: center;' }} height: 32px; width: 32px; border-radius: 50%; background-color: {{ $shippedActive ? '#c02434' : '#f1f5f9' }}; padding: 6px; {{ $shippedActive ? '' : 'border: 1px solid #e2e8f0;' }} text-align: center; color: {{ $shippedActive ? '#fff' : '#94a3b8' }};">
                                                    <svg fill="currentColor" viewBox="0 0 100 125" style="width:100%;height:100%;">
                                            ...
                                            <td style="vertical-align: middle;"><div style="height: 3px; background-color: {{ $newStatus->value === 'delivered' ? '#c02434' : '#e2e8f0' }};"></div></td>
                                            {{-- Delivered --}}
                                            @php $deliveredActive = $newStatus->value === 'delivered'; @endphp
                                            <td style="width: 32px; text-align: center;">
                                                <div class="{{ $deliveredActive ? 'step-icon-on' : 'step-icon-off' }}" style="margin: 0 auto; {{ $deliveredActive ? 'line-height: 32px;' : 'display: flex; align-items: center; justify-content: center;' }} height: 32px; width: 32px; border-radius: 50%; background-color: {{ $deliveredActive ? '#c02434' : '#f1f5f9' }}; padding: 6px; {{ $deliveredActive ? '' : 'border: 1px solid #e2e8f0;' }} text-align: center; color: {{ $deliveredActive ? '#fff' : '#94a3b8' }};">
                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                            <td style="padding-top: 6px; text-align: center;">
                                                <p class="step-label" style="margin: 0; white-space: nowrap; font-size: 9px; font-weight: {{ $shippedActive ? '700' : '600' }}; text-transform: uppercase; letter-spacing: 0.04em; color: {{ $shippedActive ? '#c02434' : '#94a3b8' }};">Shipped</p>
                                            </td>
                                            <td></td>
                                            <td style="padding-top: 6px; text-align: center;">
                                                <p class="step-label" style="margin: 0; white-space: nowrap; font-size: 9px; font-weight: {{ $deliveredActive ? '700' : '600' }}; text-transform: uppercase; letter-spacing: 0.04em; color: {{ $deliveredActive ? '#c02434' : '#94a3b8' }};">Delivered</p>
                                            </td>
                                        </tr>
                                    </table>
