        ...
        <flux:modal name="pesawise-config" class="md:w-120">
            <div class="space-y-6">
                ...
                <form wire:submit="savePesawise" class="space-y-4">
                    ...
                    <flux:input label="Webhook Secret (optional)" wire:model="pesawise_webhook_secret"
        ...
        <flux:modal name="pesapal-config" class="md:w-120">
            <div class="space-y-6">
                ...
                <form wire:submit="savePesapal" class="space-y-4">
                    ...
                    <flux:input label="Webhook Secret (optional)" wire:model="pesapal_webhook_secret"
                        type="password" />
            ...
            <div class="space-y-6">
                ...
                <form wire:submit="saveCustom" class="space-y-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <flux:input label="Webhook Secret (optional)" wire:model="stripe_webhook_secret"
                            type="password" placeholder="whsec_..." />
                    </div>
                    ...
                    <div class="space-y-4 ">
                        <div class="flex items-center justify-between">
                            ...
                            <flux:badge size="sm" :color="$mpesa_mode_production ? 'green' : 'zinc'"
                                variant="soft">
                        ...
                        <div class="flex items-center justify-between p-3 rounded-lg bg-zinc-50 dark:bg-zinc-800">
                            <div>
                                <flux:text class="text-sm font-medium">Production Mode</flux:text>
                                <flux:text class="text-xs text-zinc-400">Enable for live M-Pesa transactions
                                </flux:text>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <flux:field>
                                ...
                                <flux:description>Safaricom will send payment confirmations to this URL.
                                </flux:description>
