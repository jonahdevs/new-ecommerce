                            ...
                            <div class="sticky top-44">
                                        ...
                                        <div class="grid grid-cols-[auto_1fr_auto] items-center gap-3">
                                            ...
                                            <div class="flex gap-0.5">
                                                @for ($star = 1; $star <= 5; $star++)
                                                    @if ($star <= $rating)
                                                        <svg class="w-4 h-4 text-orange-400 fill-current"
                                                            viewBox="0 0 20 20">
                                                            <path
                                ...
                                <div class="mt-4 pt-4 border-t">
                                    <div class="text-center">
                                        ...
                                        <div class="flex justify-center gap-1 mt-1">
                                            @for ($i = 1; $i <= 5; $i++)
                                                @if ($i <= floor($this->averageRating))
                                                    <svg class="w-5 h-5 text-orange-400 fill-current"
                                                        viewBox="0 0 20 20">
                                                        <path
                                                            d="M10 15l-5.878 3.09 1.123-6.545L.489 6.91l6.572-.955L10 0l2.939 5.955 6.572.955-4.756 4.635 1.123 6.545z" />
                                                    </svg>
                                        ...
                                        <div class="text-sm text-gray-600 mt-1">{{ $this->totalReviews }}
                            ...
                            @else
                                <div class="space-y-6">
                                    @foreach ($this->reviews as $review)
                                        <div class="border-b pb-6 last:border-b-0">
                                                ...
                                                <div class="flex-1">
                                                    <div class="flex items-center gap-3 mb-1">
                                                        ...
                                                        @if ($review->is_verified_purchase)
                                                            <flux:badge icon="check-badge" size="sm"
                                                                color="green">
                                                                Verified Purchase
                                                            </flux:badge>
                                                        @endif
                                                    ...
                                                    <div class="flex items-center gap-2">
                                                        ...
                                                        <span
                                                            class="text-sm text-zinc-500">{{ $review->created_at->diffForHumans() }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            {{-- Review Text --}}
                                            <p class="text-zinc-500 text-sm mb-3">{{ $review->review_text }}</p>
                                            ...
                                            <div class="flex items-center gap-4">
                                                <p class="text-sm text-zinc-500">Was it
                                                    helpful to you?</p>

                                                <flux:radio.group>
                                                    <flux:radio label="Yes {{ $review->helpful_count }}" />
                                                    <flux:radio label="No {{ $review->not_helpful_count }}" />
                                                </flux:radio.group>
                                            </div>
                                        </div>
                                    @endforeach
                                ...
                                @if ($this->hasMoreReviews)
                                    <div class="mt-6 text-center">
                                        <flux:button>View All {{ $this->totalReviews }} Reviews</flux:button>
                                    </div>
                                @endif
                            @endif
                        </div>
