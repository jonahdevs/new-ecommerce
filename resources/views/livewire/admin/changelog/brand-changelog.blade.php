...
new #[Title('Brand Changelog')] class extends Component {
    use WithPagination;
    ...
    {
        return Activity::query()->where('subject_type', Brand::class)->where('subject_id', $this->brand->id)->with('causer')->latest()->paginate(20);
    }

    public function render(): View
    {
        return view('livewire.admin.changelog.brand-changelog');
    }
...
<div>
    <flux:breadcrumbs class="mb-2">
        ...
        <flux:breadcrumbs.item :href="route('admin.catalog.brands.index')" wire:navigate>Brands
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <flux:heading size="xl">Brand Changelog</flux:heading>
            <flux:subheading>Change history for {{ $brand->name }}</flux:subheading>
        </div>
        <flux:button :href="route('admin.catalog.brands.edit', $brand)" wire:navigate icon="arrow-left" variant="ghost">
            Back to Brand
        </flux:button>
    </div>
                ...
                <div class="flex flex-col items-center gap-3">
                    ...
                    <div>
                        ...
                        <flux:subheading class="mt-0.5">
                            Changes to this brand will appear here.
                        </flux:subheading>
                    </div>
                </div>
            </div>
